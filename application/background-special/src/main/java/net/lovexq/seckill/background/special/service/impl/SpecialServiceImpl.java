package net.lovexq.seckill.background.special.service.impl;
...
import net.lovexq.seckill.background.domain.system.model.SystemConfigModel;
import net.lovexq.seckill.background.special.client.ConfigFeignClient;
import net.lovexq.seckill.background.special.client.EstateFeignClient;
...
public class SpecialServiceImpl implements SpecialService {
    ...
    public JsonResult createData() throws Exception {
        ...
        if (CollectionUtils.isNotEmpty(estateItemModelList)) {
            ...
            configFeignClient.save(ProtoStuffUtil.serialize(sysConfigModel));
